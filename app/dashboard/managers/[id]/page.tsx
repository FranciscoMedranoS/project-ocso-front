                ...
                {data.location ? (
                    <>
                        ...
                        <iframe
                            ...
                            width="300"
                            height="200"
                            src={`https://www.google.com/maps/embed/v1/place?key=AIzaSyA1ecwUo-w3Bi8uc9c7isE-lhIRsmShN6c&q=${data.location.locationLatLng[0]},${data.location.locationLatLng[1]}`}>
                        </iframe>
                    </>
                ) : (<p>No tiene tienda</p>)
                }
